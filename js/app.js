...
var streamURL_ogg = "https://icecast.livingsounds.earth/livingsounds.ogg";
var streamURL_mp3 = "https://icecast.livingsounds.earth/livingsounds.mp3";
...
function setup_audio() {
  ...
  try {
    ...
    console.debug(
      "AudioContext is not supported for advanced audio processing. Switch to use HTML5 audio player."
    );
    ...
    console.log(
      "Your browser does't support advanced audio processing. Try again using the latest desktop version of Chrome, Firefox, or Edge."
    );
  }
  // display volume control
  document.getElementById("playButton").style.backgroundImage =
    "url('img/volume_up.svg')";
}
...
function setup_canvas() {
  ...
  document.getElementById(
    ...
    .getElementById("sketchContainer")
    .className.replace(/(?:^|\s)lowOpacity(?!\S)/g, "");
  // invoke p5
